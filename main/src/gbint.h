...
#define PROFILEENTRIES PROFILESIZEOFNAME + PROFILESIZEOFLIGHTCOLOR + PROFILESIZEOFLIGHTTIME + PROFILESIZEOFFEEDVOL + PROFILESIZEOFFEEDINTER + PROFILESIZEOFTEMPDAY + PROFILESIZEOFTEMPNIGHT + PROFILESIZEHUMDAY + PROFILESIZEOFHUMNIGHT
